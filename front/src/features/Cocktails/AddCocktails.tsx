...
import { Avatar, Box, Button, Container, Divider, Grid2, TextField, Typography } from '@mui/material';
            ...
            <Grid2 container direction={'column'} size={12} spacing={2}>
              ...
              >
                ...
                {cocktailForm.ingredients.map((ingredient, index)=>(
                  <Grid2
                    container gap={1} marginBottom={2} key={index}>
                    <Grid2>
                      <TextField
                        onChange={handleChange}
              ...
              <Button onClick={onClickAddReceipt} type='button' variant="contained" color='success' sx={{ marginLeft:'auto'}}>
                add recipe
              </Button>
              <Grid2 size={12}>
                <TextField
